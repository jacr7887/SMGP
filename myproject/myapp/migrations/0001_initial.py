    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('segundo_nombre', encrypted_model_fields.fields.EncryptedCharField(blank=True, default='', verbose_name='Segundo Nombre')),
                ('primer_apellido', encrypted_model_fields.fields.EncryptedCharField(verbose_name='Primer Apellido')),
                ('segundo_apellido', encrypted_model_fields.fields.EncryptedCharField(blank=True, default='', verbose_name='Segundo Apellido')),
                ...
                ('rif', encrypted_model_fields.fields.EncryptedCharField(blank=True, default=None, help_text='RIF de la empresa. Formato Requerido: Letra-8Números-1Número (Ej: J-12345678-9).', null=True, unique=True, validators=[myapp.validators.validate_rif], verbose_name='RIF')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cedula', encrypted_model_fields.fields.EncryptedCharField(help_text='Cédula de Identidad del afiliado. Formato: V-12345678 o E-8765432 (guion opcional).', unique=True, validators=[myapp.validators.validate_cedula], verbose_name='Cédula de Identidad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True, db_index=True, help_text='Fecha y hora en que se creó este registro (automático).', verbose_name='Fecha Creación')),
                ('fecha_modificacion', models.DateTimeField(auto_now=True, db_index=True, help_text='Fecha y hora de la última modificación de este registro (automático).', verbose_name='Fecha de Modificación')),
                ('email', encrypted_model_fields.fields.EncryptedEmailField(error_messages={'unique': 'Este correo electrónico ya está registrado.'}, help_text='Correo electrónico único.', unique=True, validators=[django.core.validators.EmailValidator()], verbose_name='Correo Electrónico')),

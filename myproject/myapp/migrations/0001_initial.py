    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primer_nombre', encrypted_model_fields.fields.EncryptedCharField(verbose_name='Primer Nombre')),
                ('segundo_nombre', encrypted_model_fields.fields.EncryptedCharField(blank=True, default='', null=True, verbose_name='Segundo Nombre')),
                ('primer_apellido', encrypted_model_fields.fields.EncryptedCharField(verbose_name='Primer Apellido')),
                ('segundo_apellido', encrypted_model_fields.fields.EncryptedCharField(blank=True, default='', null=True, verbose_name='Segundo Apellido')),
                ...
                ('razon_social', encrypted_model_fields.fields.EncryptedCharField(help_text='Nombre legal completo de la empresa o institución.', verbose_name='Razón Social')),
                ('rif', encrypted_model_fields.fields.EncryptedCharField(blank=True, default=None, help_text='RIF de la empresa. Formato Requerido: Letra-8Números-1Número (Ej: J-12345678-9).', null=True, validators=[myapp.validators.validate_rif], verbose_name='RIF')),
                ('rif_hash', models.CharField(blank=True, db_index=True, editable=False, max_length=64, unique=True, verbose_name='Hash del RIF (para búsquedas)')),
                ...
                ('direccion_comercial', encrypted_model_fields.fields.EncryptedTextField(blank=True, help_text='Ej: Av. Principal, Edif. Torreón, Piso 5, Municipio Chacao', null=True, verbose_name='Dirección Fiscal')),
                ...
                ('telefono_contacto', encrypted_model_fields.fields.EncryptedCharField(blank=True, help_text='Número de teléfono principal de contacto. Formato: 04XX-XXXXXXX o 02XX-XXXXXXX.', null=True, validators=[myapp.validators.validate_telefono_venezuela], verbose_name='Teléfono Principal')),
                ('email_contacto', encrypted_model_fields.fields.EncryptedEmailField(blank=True, help_text='Correo electrónico principal de contacto de la empresa.', null=True, validators=[django.core.validators.EmailValidator()], verbose_name='Email Corporativo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cedula', encrypted_model_fields.fields.EncryptedCharField(help_text='Cédula de Identidad del afiliado. Formato: V-12345678 o E-8765432 (guion opcional).', validators=[myapp.validators.validate_cedula], verbose_name='Cédula de Identidad')),
                ('cedula_hash', models.CharField(blank=True, db_index=True, editable=False, max_length=64, unique=True, verbose_name='Hash de la Cédula (para búsquedas)')),
                ...
                ('fecha_nacimiento', encrypted_model_fields.fields.EncryptedDateField(help_text='Fecha de nacimiento del afiliado. Formato: AAAA-MM-DD.', validators=[myapp.validators.validate_past_date], verbose_name='Fecha de Nacimiento')),
                ...
                ('direccion_habitacion', encrypted_model_fields.fields.EncryptedTextField(blank=True, help_text='Dirección completa de residencia. Mínimo 10 caracteres.', null=True, verbose_name='Dirección Habitación')),
                ('telefono_habitacion', encrypted_model_fields.fields.EncryptedCharField(blank=True, help_text='Teléfono de contacto residencial. Formato: 04XX-XXXXXXX o 02XX-XXXXXXX.', null=True, verbose_name='Teléfono Habitación')),
                ('email', encrypted_model_fields.fields.EncryptedEmailField(blank=True, help_text='Correo electrónico personal del afiliado (opcional).', null=True, verbose_name='Correo Electrónico')),
                ('direccion_oficina', encrypted_model_fields.fields.EncryptedTextField(blank=True, help_text='Dirección del lugar de trabajo del afiliado (opcional).', null=True, verbose_name='Dirección Oficina')),
                ('telefono_oficina', encrypted_model_fields.fields.EncryptedCharField(blank=True, help_text='Teléfono de contacto laboral. Formato: 04XX-XXXXXXX o 02XX-XXXXXXX.', null=True, verbose_name='Teléfono Oficina')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_nacimiento', encrypted_model_fields.fields.EncryptedDateField(blank=True, null=True, validators=[myapp.validators.validate_past_date], verbose_name='Fecha de Nacimiento')),
                ...
                ('telefono', encrypted_model_fields.fields.EncryptedCharField(blank=True, null=True, validators=[myapp.validators.validate_telefono_venezuela], verbose_name='Teléfono')),
                ('direccion', encrypted_model_fields.fields.EncryptedTextField(blank=True, null=True, verbose_name='Dirección')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('razon_social', encrypted_model_fields.fields.EncryptedCharField(help_text='Nombre legal completo de la empresa contratante.', null=True, verbose_name='Razón Social de la Empresa')),
                ('rif', encrypted_model_fields.fields.EncryptedCharField(blank=True, help_text='RIF de la empresa contratante (copiado automáticamente).', null=True, validators=[myapp.validators.validate_rif], verbose_name='RIF de la Empresa (Copiado)')),
                ...
                ('direccion_comercial', encrypted_model_fields.fields.EncryptedTextField(blank=True, help_text='Dirección principal o fiscal de la empresa contratante.', null=True, verbose_name='Dirección Comercial')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contratante_cedula', encrypted_model_fields.fields.EncryptedCharField(help_text='Cédula o RIF de quien paga. Introduzca V/E + 7-8 dígitos (Cédula) o J/G/V/E + 8 dígitos + verificador (RIF, formato con guiones requerido).', verbose_name='Cédula/RIF del Contratante')),
                ('contratante_nombre', encrypted_model_fields.fields.EncryptedCharField(help_text='Nombre completo o razón social de quien paga el contrato.', verbose_name='Nombre del Contratante')),
                ('direccion_contratante', encrypted_model_fields.fields.EncryptedTextField(blank=True, help_text='Dirección fiscal o principal del contratante.', null=True, verbose_name='Dirección del Contratante')),
                ('telefono_contratante', encrypted_model_fields.fields.EncryptedCharField(blank=True, help_text='Teléfono de contacto del contratante. Formato: 04XX-XXXXXXX o 02XX-XXXXXXX.', null=True, validators=[myapp.validators.validate_telefono_venezuela], verbose_name='Teléfono del Contratante')),
                ('email_contratante', encrypted_model_fields.fields.EncryptedEmailField(blank=True, help_text='Correo electrónico principal del contratante.', null=True, validators=[django.core.validators.EmailValidator()], verbose_name='Email del Contratante')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_completo', encrypted_model_fields.fields.EncryptedCharField(help_text='Nombre completo o razón social del intermediario.', verbose_name='Nombre Completo del Intermediario')),
                ('rif', encrypted_model_fields.fields.EncryptedCharField(blank=True, help_text='Formato Requerido: Letra-8Números-1Número (Ej: J-12345678-9).', null=True, validators=[myapp.validators.validate_rif], verbose_name='RIF')),
                ('rif_hash', models.CharField(blank=True, db_index=True, editable=False, max_length=64, null=True, verbose_name='Hash del RIF (para búsquedas)')),
                ('direccion_fiscal', encrypted_model_fields.fields.EncryptedTextField(blank=True, help_text='Dirección fiscal registrada del intermediario.', null=True, verbose_name='Dirección Fiscal')),
                ('telefono_contacto', encrypted_model_fields.fields.EncryptedCharField(blank=True, help_text='Formato: 04XX-XXXXXXX o 02XX-XXXXXXX.', null=True, validators=[myapp.validators.validate_telefono_venezuela], verbose_name='Teléfono de Contacto')),
                ('email_contacto', encrypted_model_fields.fields.EncryptedEmailField(blank=True, help_text='Correo electrónico principal de contacto del intermediario.', null=True, validators=[django.core.validators.EmailValidator()], verbose_name='Email de Contacto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monto', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0.00'), help_text='Monto base (subtotal) de la factura.', max_digits=15, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mensaje', encrypted_model_fields.fields.EncryptedTextField(verbose_name='Mensaje')),
                ('tipo', models.CharField(choices=[('info', 'Información'), ('success', 'Éxito'), ('warning', 'Advertencia'), ('error', 'Error'), ('system', 'Sistema')], default='info', verbose_name='Tipo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion_reclamo', encrypted_model_fields.fields.EncryptedTextField(help_text='Descripción detallada del motivo de la reclamación realizada por el cliente.', verbose_name='Descripción del Reclamo')),
                ...
                ('observaciones_internas', encrypted_model_fields.fields.EncryptedTextField(blank=True, help_text='Notas o comentarios internos del personal sobre la reclamación (no visibles al cliente).', null=True, verbose_name='Observaciones Internas')),
                ('observaciones_cliente', encrypted_model_fields.fields.EncryptedTextField(blank=True, help_text='Comentarios o respuestas proporcionadas al cliente sobre el estado o resolución de la reclamación.', null=True, verbose_name='Observaciones para el Cliente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referencia_pago', encrypted_model_fields.fields.EncryptedCharField(blank=True, help_text='Identificador único del pago (ej. N° transferencia).', verbose_name='Referencia de Pago')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalle_accion', encrypted_model_fields.fields.EncryptedTextField(blank=True, help_text='Descripción detallada de la acción realizada o del error ocurrido.', null=True, verbose_name='Detalle de la Acción')),
                ('direccion_ip', encrypted_model_fields.fields.EncryptedCharField(blank=True, db_index=True, help_text='Dirección IP desde la cual se originó la acción.', null=True, verbose_name='Dirección IP')),
                ('agente_usuario', encrypted_model_fields.fields.EncryptedTextField(blank=True, help_text='Información del navegador o cliente utilizado para realizar la acción.', null=True, verbose_name='Agente de Usuario (User Agent)')),

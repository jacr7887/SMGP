# Generated by Django 5.2 on 2025-05-31 03:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pagos_realizados', models.PositiveIntegerField(blank=True, default=0, editable=False, help_text='Número de pagos o cuotas abonadas para este contrato hasta la fecha.', verbose_name='Pagos Realizados')),
                ...
                ('monto_total', models.DecimalField(db_index=True, decimal_places=2, help_text='Costo total del contrato para el período de vigencia especificado.', max_digits=15, verbose_name='Monto Total del Contrato')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_identificacion_contratante', models.CharField(choices=[('V', 'Venezolano'), ('E', 'Extranjero'), ('J', 'Jurídica'), ('G', 'Gobierno')], help_text='Tipo de documento (Cédula o RIF) de la persona o entidad que paga el contrato.', max_length=1, verbose_name='Tipo de Identificación del Contratante')),
                ...
                ('comision_anual', models.DecimalField(blank=True, decimal_places=2, help_text='Porcentaje de comisión anual para el intermediario. Entre 0.00 y 100.00.', max_digits=5, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Comisión Anual (%)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estatus_factura', models.CharField(choices=[('PENDIENTE', 'Pendiente'), ('PAGADA', 'Pagada'), ('VENCIDA', 'Vencida')], db_index=True, default='GENERADA', help_text='Estado del ciclo de vida de la factura (ej. Generada, Cobranza, Pagada, Anulada).', max_length=50, verbose_name='Estatus de Factura')),
                ...
                ('monto', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Monto base (subtotal) de la factura. Debe ser mayor a 0.', max_digits=15, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ...
                ('dias_periodo_cobro', models.IntegerField(blank=True, help_text='Duración en días del período que cubre la factura (calculado o manual).', null=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Días del período de cobro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monto_reclamado', models.DecimalField(decimal_places=2, help_text='Monto solicitado por el cliente en la reclamación. Debe ser mayor a 0.', max_digits=15, validators=[django.core.validators.MinValueValidator(0.01)], verbose_name='Monto Reclamado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comision_intermediario', models.DecimalField(blank=True, decimal_places=2, help_text='Porcentaje de comisión para el intermediario asociado a contratos que usen esta tarifa (0.00-100.00).', max_digits=5, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.00')), django.core.validators.MaxValueValidator(Decimal('100.00'))], verbose_name='Comisión Intermediario (%)')),
            ],
            options={
                'verbose_name': 'Tarifa',

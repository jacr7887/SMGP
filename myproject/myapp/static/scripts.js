...
function initCarousel() {
    ...
    function showSlide(targetVisibleIndex, forceUpdate = false) {
        ...
        if (!forceUpdate && currentVisibleIndex === targetVisibleIndex) { if (activeItemForResize && typeof triggerPlotlyResize === 'function') triggerPlotlyResize(activeItemForResize); return; }
        ...
        if (activeItemForResize && typeof triggerPlotlyResize === 'function') triggerPlotlyResize(activeItemForResize);
    }
